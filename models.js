...
//   {name: 'campaign', text: 'Active campaign', width: 180, hidden: true, renderer: renderCampaign},
   ...
   {name: 'lastName', text: 'Last name', width: 100, lock: true},
...
fields['CRM_CORPORATE_FIELDS'] = [
   ...
   {name: 'firstName', text: 'Name', width: 180, lock: true, renderer: renderTip, primary: true},
   {name: 'lastName', text: 'Parent name', width: 120, lock: true},
...
function renderTip(v, metadata, record, rowIndex, colIndex, store) {
	...
	return '<a href="" class="select_customer>'+v+'</a>';
}
