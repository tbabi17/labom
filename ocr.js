					...
					tbar: [{
						...
						menu: {
							...
							items: [{
								text: 'Today',
								handler: function() {
									Ext.getCmp('start_2').setText(me.today());
									Ext.getCmp('end_2').setText( me.tommorow());
									me.charts[2].rangeData(me.today(), me.tommorow());
								}
							},{
								text: 'This week',
								handler: function() {
									Ext.getCmp('start_2').setText(me.monday());
									Ext.getCmp('end_2').setText( me.tommorow());
								...
								text: 'This month',
								handler: function() {
									Ext.getCmp('start_2').setText(me.month());
								...
								text: 'This year',
								handler: function() {
									Ext.getCmp('start_2').setText(me.year());
									Ext.getCmp('end_2').setText( me.nextyear());
									me.charts[2].rangeData(me.year(), me.nextyear());
								}
							},{
								text: 'Last year',
								handler: function() {
									Ext.getCmp('start_2').setText(me.prevyear());
									Ext.getCmp('end_2').setText( me.year());
									me.charts[2].rangeData(me.prevyear(), me.year());
								}
							}]
						}
					},'->',
					...
					},
					{
						...
						menu: Ext.create('Ext.menu.DatePicker', {
							handler: function(dp, date){
								...
								me.charts[2].rangeData(me.charts[9].start, me.charts[2].end);
							}
						})
					},{
						text: 'Reset',
						...
						handler: function() {
							Ext.getCmp('start_2').setText(me.month());
							Ext.getCmp('end_92').setText(me.nextmonth());
							me.charts[9].rangeData(me.charts[2].month(), me.charts[2].nextmonth());
						}
					}],
					items: me.charts[2]
				}]
